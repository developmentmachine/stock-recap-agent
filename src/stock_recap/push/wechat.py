...
from stock_recap.models import Recap
from stock_recap.render.renderers import render_markdown_for_wechat_work, render_wechat_text

logger = logging.getLogger("stock_recap.push.wechat")
